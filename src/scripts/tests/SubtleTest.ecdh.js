...
var q1 = {
    ...
    extractable: true,
    crv: "P-256",
    x: msrCrypto.toBase64([0x1B, 0x16, 0x31, 0xC5, 0xDC, 0x76, 0xD3, 0x78, 0xA9, 0x14, 0xC9, 0x67, 0x29, 0xD0, 0xA5, 0x94, 0xD5, 0x4B, 0x4F, 0x58, 0x84, 0x5B, 0x1D, 0x4A, 0x4B, 0x6B, 0xE7, 0x39, 0xCA, 0x4A, 0x18, 0xEA]),
    y: msrCrypto.toBase64([0x4F, 0x85, 0xE4, 0xC9, 0x26, 0xEE, 0x53, 0x23, 0x90, 0xAA, 0x7C, 0xD4, 0x14, 0x94, 0x35, 0x37, 0x25, 0xE6, 0xE8, 0x04, 0x71, 0x4A, 0xA6, 0x9D, 0x67, 0x07, 0x2F, 0x65, 0xDB, 0x62, 0x5E, 0x07]),
    d: msrCrypto.toBase64([0x8F, 0xED, 0x78, 0x43, 0x1D, 0x82, 0x55, 0x8D, 0x90, 0x06, 0xC3, 0xDE, 0xB0, 0x6A, 0xB5, 0x8D, 0x9D, 0xCC, 0xC9, 0x71, 0x06, 0x87, 0x5C, 0x67, 0x25, 0xD5, 0xF1, 0x66, 0x25, 0x5B, 0xA9, 0x0A])
}
...
var q2 = {
    ...
    extractable: true,
    crv: "P-256",
    x: msrCrypto.toBase64([0x2A, 0xF5, 0x02, 0xF3, 0xBE, 0x89, 0x52, 0xF2, 0xC9, 0xB5, 0xA8, 0xD4, 0x16, 0x0D, 0x09, 0xE9, 0x71, 0x65, 0xBE, 0x50, 0xBC, 0x42, 0xAE, 0x4A, 0x5E, 0x8D, 0x3B, 0x4B, 0xA8, 0x3A, 0xEB, 0x15]),
    y: msrCrypto.toBase64([0xEB, 0x0F, 0xAF, 0x4C, 0xA9, 0x86, 0xC4, 0xD3, 0x86, 0x81, 0xA0, 0xF9, 0x87, 0x2D, 0x79, 0xD5, 0x67, 0x95, 0xBD, 0x4B, 0xFF, 0x6E, 0x6D, 0xE3, 0xC0, 0xF5, 0x01, 0x5E, 0xCE, 0x5E, 0xFD, 0x85]),
    d: msrCrypto.toBase64([0x81, 0x42, 0x64, 0x14, 0x5F, 0x2F, 0x56, 0xF2, 0xE9, 0x6A, 0x8E, 0x33, 0x7A, 0x12, 0x84, 0x99, 0x3F, 0xAF, 0x43, 0x2A, 0x5A, 0xBC, 0xE5, 0x9E, 0x86, 0x7B, 0x72, 0x91, 0xD5, 0x07, 0xA3, 0xAF])
}
...
function getKeyFromBytes(privateKeyBytes, callback, callbackParam) {
    ...
    var privateKey = {
        "kty": "EC",
        "extractable": true,
        "d": msrCrypto.toBase64(privateKeyBytes),
        "crv": "P-256"
    }

    var keyBytes = shared.textToBytes(JSON.stringify(privateKey));
...
asyncTest("ECDH/KDF Test", function () {
    ...
    var key1Bytes = shared.textToBytes(JSON.stringify(q1));
    var key2Bytes = shared.textToBytes(JSON.stringify(q2));
            ...
            cryptoOp.oncomplete = function (e) {
                ...
                keyOpImport3.oncomplete = function (e3) {
                    ...
                    keyOpDeriveBits.oncomplete = function (e4) {
                        ...
                        var derivedBytes = shared.getArrayResult(e4.target.result);
                    ...
                    keyOpDeriveBits.onerror = shared.error("deriveBits");
