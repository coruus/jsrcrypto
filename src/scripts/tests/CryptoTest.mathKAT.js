...
mathKATs.StringDigitConversion = function (radix) {
    for (var i = 0; i < mathKATs.kat.length; ++i) {
        ...
        // Verify the results
        var pass = cryptoMath.sequenceEqual(remainder, r) &&
            cryptoMath.sequenceEqual(quotient, q) &&
            cryptoMath.sequenceEqual(dividend, dvd) &&
            cryptoMath.sequenceEqual(divisor, dvs);
...
test("Division", function () {
    ...
    for (var i = 0; i < mathKATs.kat.length; ++i) {
        ...
        // Verify the results
        var pass = cryptoMath.sequenceEqual(actualQuotient, quotient) &&
            cryptoMath.sequenceEqual(actualRemainder, remainder);
...
test("Multiply & Add", function () {
    ...
    for (var i = 0; i < mathKATs.kat.length; ++i) {
        ...
        // Verify the results
        var pass = cryptoMath.sequenceEqual(actualProduct, product);
