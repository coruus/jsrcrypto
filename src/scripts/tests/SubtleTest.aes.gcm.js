...
var aesGcmTest = {
    ...
    aesEncryptionComplete: function (expectedCipher, expectedTag, algorithm) {
        return function (e) {
            ...
            var result = shared.getArrayResult(e.target.result);
    ...
    aesRoundTrip: function (resultStorageArray, keyBytes, plainBytes, addBytes, ivBytes, expected, sync, process) {
        ...
        shared.importKey("aes-gcm", jwkKeyString, function (key) {
            ...
            if (addBytes.length > 0 || shared.flip(50)) {
            ...
            cryptoOpEnc.oncomplete = function (e) {
                ...
                var cipherPlusTagResult = shared.toSupportedArray(e.target.result);
                ...
                if (process) {
                    var sections = shared.partitionData(cipherPlusTagResult);
            ...
            if (process) {
                var sections = shared.partitionData(plainBytes);
                for (var i = 0; i < sections.length; i++) {
